...
Begin {
    ...
    Function Get-ServiceUpTime {
        ...
        Try{
            ...
            else { $ServiceProcessID = (Get-CimInstance -Class Win32_Service -Filter "Name='$($Name)'").ProcessID }
    ...
    Function Get-OperatingSystem {
        ...
        #else { $OS = Get-CimInstance Win32_OperatingSystem }
    ...
    Function Get-LastInstalledPatches {
        ...
        Switch -Wildcard ($OS) {
            ...
            "*Windows 11*" {
                $Date = $Searcher.QueryHistory(0, $HistoryCount) | Where-Object {
                    ($_.ClientApplicationID -eq 'MoUpdateOrchestrator' -or $_.ClientApplicationID -eq 'ccmexec') -and ($_.Title -notmatch "Security Intelligence Update|Definition Update")
                } | Select-Object -ExpandProperty Date | Measure-Latest
            }
            "*Server 2008*" {
                $Date = $Searcher.QueryHistory(0, $HistoryCount) | Where-Object {
    ...
    Function Test-Service {
        ...
        elseif ($StartupType -like "Automatic (Delayed Start)") {
            ...
            if ( (($name -eq "wuauserv") -or ($name -eq "W32Time")) -and (($OSName -like "Windows 1*") -or ($OSName -like "*Server 2016*")-or ($OSName -like "*Server 2019*")-or ($OSName -like "*Server 2022*")) ) {
    ...
    Function Test-SCCMHardwareInventoryScan {
        ...
        $wmi = Get-CimInstance -Namespace root\ccm\invagt -Class InventoryActionStatus | Where-Object {$_.InventoryActionID -eq '{00000000-0000-0000-0000-000000000001}'} | Select-Object @{label='HWSCAN';expression={$_.LastCycleStartedDate}}
